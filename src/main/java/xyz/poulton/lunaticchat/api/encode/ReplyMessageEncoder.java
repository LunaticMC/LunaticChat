...
public class ReplyMessageEncoder implements MessageEncoder {
    private final ReplyMessage message;

    public ReplyMessageEncoder(ReplyMessage message) {
    ...
    @Override
    public ReplyMessage decodeMessage(ByteArrayDataInput in) {
